...
import config
import logging
import JackGrammar, CompilationEngine
    ...
    for line in validlines:
        ...
        while i < len(line):
            ...
            # Check for identifiers (variable names)
                ...
                logging.warning(f"Unrecognized character in line: [{char}] ({line})")
                i += 1

    CompilationEngine.startParsing(output_path, tokens=tokens, filename=filename)
